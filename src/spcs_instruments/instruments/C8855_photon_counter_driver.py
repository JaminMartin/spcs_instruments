...
class C8855_counting_unit(RexSupport):
    ...
    transfer_type_mapping = {"single_transfer": 1, "block_transfer": 2}

    C8855_SINGLE_TRANSFER = 1
    C8855_BLOCK_TRANSFER = 2

    trigger_type_mapping = {"software": 0, "external": 1}
    ...
    def __init__(
        self, config: str, name: str = "C8855_photon_counter", connect_to_rex=True
    ):
        """
        ...
        self.measurements = {
            ...
            "trace": Measurement(data=[], unit="counts"),
        }
        self.setup_config()
    ...
    def setup_config(self):
        ...
        self.transfer_type = self.transfer_type_mapping[
            self.require_config("transfer_type")
        ]
        ...
        self.dll.C8855Open.restype = (
            ctypes.c_void_p
        )  # Assuming the handle is a void pointer
    ...
    def general_measurement(self):
        ...
        if self.device_handle:
            success = self.setup_device(
                self.device_handle,
                gate_time=self.gate_time,
                transfer_mode=self.transfer_type,
    ...
    def measure(self):
        ...
        match self.measure_mode:
            ...
            case "trace":
                self.measurements["trace"] = Measurement(
                    data=bin_average_array,
                    unit="counts",
                )

                self.measurements["counts"].data = []
    ...
    def setup_device(
        ...
        gate_time: ctypes.c_ubyte,
        transfer_mode: ctypes.c_ubyte,
        number_of_gates: ctypes.c_ushort,
    ) -> bool:
        """
    ...
    def start_counting(
        self,
        handle: ctypes.c_void_p,
        trigger_mode: ctypes.c_ubyte = C8855_EXTERNAL_TRIGGER,
    ) -> bool:
        """
