...
class SCryostation(genericcryostat.GenericCryostat):
    def __init__(
        self, ip, version="v1", verbose=False, tunnel=False, port=Ports.scryostation_hlm
    ):
        super().__init__(
    ...
    def get_sample_chamber_pressure(self):
        return self.get_prop(
            "/vacuumSystem/vacuumGauges/sampleChamberPressure/properties/pressureSample"
    ...
    def set_platform_bakeout_temperature(self, temperature):
        return self.set_prop(
            "/controller/properties/platformBakeoutTemperature", temperature
        )
    ...
    def get_platform_temperature_stability(self):
        ...
        return r["sample"]["temperatureStabilityOK"], r["sample"][
    ...
    def get_platform_heater_sample(self):
        r = self.get_prop(
            "/sampleChamber/temperatureControllers/platform/heater/properties/sample"
        )
        return r["sample"]
    ...
    def get_user1_heater_sample(self):
        r = self.get_prop(
            "/sampleChamber/temperatureControllers/user1/heater/properties/sample"
        )
        return r["sample"]
    ...
    def get_user2_heater_sample(self):
        r = self.get_prop(
            "/sampleChamber/temperatureControllers/user2/heater/properties/sample"
        )
        return r["sample"]
    ...
    def get_cryooptic_heater_sample(self):
        r = self.get_prop(
            "/sampleChamber/temperatureControllers/cryoOptic/heater/properties/sample"
        )
        return r["sample"]
